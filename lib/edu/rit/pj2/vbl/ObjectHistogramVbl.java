//******************************************************************************
//
// File:    ObjectHistogramVbl.java
// Package: edu.rit.pj2.vbl
// Unit:    Class edu.rit.pj2.vbl.ObjectHistogramVbl
//
...
/**
 * Class ObjectHistogramVbl is the abstract base class for a histogram that
 * categorizes values of an object type into bins and counts the number of
 * occurrences in each bin. The {@link #bin(Object) bin()} method determines the
 * bin for a given value; this method must be overridden in a subclass.
 * <P>
 * Class ObjectHistogramVbl supports doing a chi-square test on the bin counts.
 * See the {@link #chisqr() chisqr()}, {@link #pvalue(double) pvalue()}, and
 * {@link #expectedCount(int) expectedCount()} methods.
 * <P>
 * Class ObjectHistogramVbl supports the <I>parallel reduction</I> pattern. Each
 ...
 * @version 06-Feb-2015
 */
public abstract class ObjectHistogramVbl<T>
...
// Exported operations.
	 ...
	 * {@link #bin(Object) bin(x)} method is incremented.
	 *
	 * @param  x  Value.
	 */
