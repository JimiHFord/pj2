...
// Exported operations.
	 ...
	 * <P>
	 * The DoubleVbl base class's <TT>reduce()</TT> method leaves this shared
	 * variable unchanged.
	 *
	 * @param  vbl  Shared variable.
	 *
...
// Exported subclasses.
	...
	public static class Min
		...
		public void reduce
			(Vbl vbl)
			{
			this.item = Math.min (this.item, ((DoubleVbl)vbl).doubleValue());
			}
		}
	...
	public static class Max
		...
		public void reduce
			(Vbl vbl)
			{
			this.item = Math.max (this.item, ((DoubleVbl)vbl).doubleValue());
			}
		}
