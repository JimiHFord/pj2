//******************************************************************************
//
// File:    FloatHistogramVbl.java
// Package: edu.rit.pj2.vbl
// Unit:    Class edu.rit.pj2.vbl.FloatHistogramVbl
//
...
/**
 * Class FloatHistogramVbl is the abstract base class for a histogram that
 * categorizes values of type <TT>float</TT> into bins and counts the number of
 * occurrences in each bin. The {@link #bin(float) bin()} method determines the
 * bin for a given value; this method must be overridden in a subclass.
 * <P>
 * Class FloatHistogramVbl supports doing a chi-square test on the bin counts.
 * See the {@link #chisqr() chisqr()}, {@link #pvalue(double) pvalue()}, and
 * {@link #expectedCount(int) expectedCount()} methods.
 * <P>
 * Class FloatHistogramVbl supports the <I>parallel reduction</I> pattern. Each
 ...
 * @version 06-Feb-2015
 */
public abstract class FloatHistogramVbl
...
// Exported operations.
	 ...
	 * {@link #bin(float) bin(x)} method is incremented.
	 *
	 * @param  x  Value.
	 */
