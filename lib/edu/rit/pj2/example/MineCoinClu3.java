...
// Task classes.
	...
	private static class WorkerTask
		...
		public void main
			...
			// Do computation and termination check in parallel.
			parallelDo (new Section()
				{
				public void run() throws Exception
					{
					// Computation section.
					// Try all nonces in the chunk until the digest has N
					// leading zero bits or until another worker has found the
					// solution.
			...
			new Section()
				...
				public void run() throws Exception
					{
					// Termination check section.
					readTuple (new EmptyTuple());
					stop = true;
					}
				});
			}
